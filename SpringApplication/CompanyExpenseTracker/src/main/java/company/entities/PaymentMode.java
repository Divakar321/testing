...
public class PaymentMode {
	...
	@NotBlank(message = "Payment Name should not be blank")
    @Size(min = 1, max = 30, message = "Payment Name length should be between 1 and 30 characters")
	@Column(name = "payment_name")
	private String paymentName;
	
	@Size(max = 20, message = "Remarks length should not exceed 100 characters")
	@Column(name = "remarks")
