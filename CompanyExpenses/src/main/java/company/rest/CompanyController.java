...
public class CompanyController {
	...
	@Operation(summary = "Get all Expenditures", description = "Retrieve all expenditure details.")
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "204", description = "Payment mode updated successfully"),
			@ApiResponse(responseCode = "404", description = "Payment mode not found"),
			@ApiResponse(responseCode = "400", description = "Bad request") })
	public void updatePaymentMode(@PathVariable("paymentCode") String code, @ Valid @RequestBody PaymentMode mode) {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Department updated successfully"),
			@ApiResponse(responseCode = "404", description = "Department not found"),
			@ApiResponse(responseCode = "400", description = "Bad request") })
	public void updatePaymentMode(@PathVariable("departmentCode") int deptCode,@Valid @RequestBody Department department) {
	...
	@Operation(summary = "Get expenses by category", description = "Retrieve expenses by a given category code and sort by id using pagination")
	...
	@GetMapping("/getAllExpensesByCategoryNQ/{catCode}")
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Expenditures retrieved successfully"),
			...
			@ApiResponse(responseCode = "500", description = "Internal server error") })
	public Page<Expenditure> findByCatCode(@PathVariable String catCode,
	...
	@GetMapping("/getAllExpensesByPageModeNQ/{paymentCode}")
	...
	@GetMapping("/getAllExpensesByPaymentMode/{paymentCode}")

	@Operation(summary = "Get expenses by payment mode", description = "Retrieve expenses by a given payment mode code and sort by id using pagination")

	@ApiResponses(value = {

			@ApiResponse(responseCode = "200", description = "Expenses found by the given payment code"),

			@ApiResponse(responseCode = "404", description = "No expenses for the given PaymentCode") })

	public Page<Expenditure> getExpensesByPaymentMode(@PathVariable String paymentCode,
		...
		try {
			...
			Page<Expenditure> expenses = (Page<Expenditure>) expenditureRepo.findExpensesByPaymentMode(paymentCode,

					PageRequest.of(pageable.getPageNumber(), pageSize, sort));

			if (expenses.isEmpty()) {

				throw new ResponseStatusException(HttpStatus.NOT_FOUND, "No expenses for given PaymentCode!");
